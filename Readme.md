...
<img src="./assets/profile-header.svg" alt="Vladislav Khramenko — Python Backend Engineer based in Innopolis, Russia" width="100%" />
...
**Neurodjimmy — Python Backend Developer**<br>
...
**SEZ Alabuga — Lead Specialist / Python Backend Developer**<br>
...
<details>
<summary>A few more things under the hood</summary>
...
Bachelor's degree in Computer Science and Engineering — **expected 2030**<br>
Specialization: Data Analysis and Artificial Intelligence.

**Yelabuga Polytechnic College · 2026**<br>
...
<picture>
  ...
  <img src="./assets/lifetime.light.svg" alt="Invcxze's combined GitHub and archived GitLab activity across all years" width="100%" />
</picture>
...
<picture>
  ...
  <img src="./assets/contributions.light.svg" alt="Invcxze's recent combined GitHub and archived GitLab activity by month" width="100%" />
</picture>

<details>
<summary>For the statistically curious</summary>
<br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/overview.dark.svg" />
  <img src="./assets/overview.light.svg" alt="An overview of Invcxze's GitHub statistics" width="100%" />
</picture>
...
<p><strong>When the tests pass on the first try.</strong></p>

<img src="./assets/tests-passed.gif" alt="An excited reaction to the tests passing on the first try" width="280" />
</div>
